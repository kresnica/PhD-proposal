...
With this powerful tools we will examine several theoretical and experimental example cases of soft-matter metamaterials. 
As a model case we will firstly explore optically anisotropic systems with the eigenvalues of the permittivity tensor with different signs. 
Firstly we will be interested in a case on refraction from vacuum into a system with optical axis homogeneous across the material and 
